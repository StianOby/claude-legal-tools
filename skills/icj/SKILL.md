---
name: icj
description: Use whenever the user needs material from the International Court of Justice (ICJ) or its predecessor the Permanent Court of International Justice (PCIJ) — case law, advisory opinions, jurisdictional facts, optional-clause declarations, or treaty bases. Triggers include any reference to a named ICJ/PCIJ case (Nicaragua v. United States, Nuclear Weapons Advisory Opinion, S.S. "Wimbledon", Lotus, Chorzów, Whaling in the Antarctic, Bosnia Genocide, Israeli Wall, Chagos, South West Africa, Arrest Warrant, Land and Maritime Boundary, etc.); ICJ case numbers (case/151) or PCIJ series codes (A01, A/B 53, B-04); article-36 declarations, Article 36(2) optional clause, compulsory jurisdiction, reservations, reciprocity; jurisdictional bases (special agreement, treaty clause, forum prorogatum, Article 35); states entitled to appear, states not parties, organs/agencies entitled to request advisory opinions; natural-language asks like "would Norway and Finland's declarations support an ICJ case on a territorial dispute", "which states have accepted compulsory jurisdiction", "find the PCIJ Lotus judgment", "what did the ICJ say in the Nicaragua case", "hva sa ICJ i Whaling-saken". Also use even when the Court isn't named, if the question requires the text or metadata of an ICJ/PCIJ judgment, advisory opinion, order, or jurisdictional document. Prefer this skill over training-data recall — declarations and case law change and only icj-cij.org is authoritative. Do NOT use for: ECtHR / Strasbourg case law (use hudoc); CJEU / EU law (use eurlex); Norwegian domestic law (lovdata); Council of Europe treaties (ets); UN treaty status outside the ICJ context (untc); the EFTA Court (efta-court). Pleadings and verbatim records are intentionally out of scope — a separate skill will handle hearing documents.
---
